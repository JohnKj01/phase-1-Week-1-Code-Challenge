...
nhifyes.addEventListener('change', function(){
    if(this.checked){
        deduct_nhif = true;
    }//listening for true nhif deduction
})

nhifno.addEventListener('change', function () {
    if (this.checked) {
        deduct_nhif = false;
    }//listening for false nhif deduction
})

nssfyes.addEventListener('change', function () {
    if (this.checked) {
        deduct_nssf = true;
    }//listening for true nssf deduction
})

nssfno.addEventListener('change', function () {
    if (this.checked) {
        deduct_nssf = false;
    }//listening for false nssf deduction
})

nssfnewates.addEventListener('change', function () {
    if (this.checked) {
        isNewRates = true;
    }//listening for new regime of nhif deduction
});

oldRates.addEventListener('change', function () {
    if (this.checked) {
        isNewRates = false;
    }//listening for old regime of nhif deduction
});

month.addEventListener('change', function () {
    if (this.checked) {
        monthly = true;
    }//listening for monthly deduction
});
